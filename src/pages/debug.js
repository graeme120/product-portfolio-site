...
import tester3 from "../images/tester-images/16x9.png";
    ...
    <!-- top section writeup  --> */}
        ...
        <div className="content--block fade-in">
          <div className="content--main">
            ...
            <p className="project-writeup-description">
              ...
              ambitious project I was tasked with creating a proposal for a new
              interface rebuilding the plant specimen discovery mechanism from
              the ground up.
            </p>
        ...
        <div className="content--block">
          ...
          <div className="content--main">
            ...
            <p className="fade-in">
              ...
              curve. We are prone to impulse spending, As college students,
              myself and many of my peers are managing our finances for the very
              first time which… comes with a learning curve. We are prone to
              impulse spending,As college students, myself and many of my peers
              are managing our finance As college students, myself and many of
              my peers are managing our finances for the very first time which…
              comes with a learning curve. We are prone to impulse spending,
            </p>
            <img
      ...
      <div className="content--block addition" id="grey">
        <div className="fade-in content--main content--two-columns">
          <div className="content--half">
            <h3>Iteration One</h3>
            <img className="content--image-wrapper-full" src="3x2.png"></img>
            <h4>
              This is the caption of the image, it is so small and teeny oo aaa
            </h4>
          </div>
          <div className="content--half">
            <h3>Iteration Two</h3>
      ...
      <div className="content--block addition-bottom" id="grey">
        <div className="fade-in content--main content--two-columns">
          <div className="content--half">
            <h3>Iteration One</h3>
            <img className="content--image-wrapper-full" src="4x3.png"></img>
            <h4>
              This is the caption of the image, it is so small and teeny oo aaa
            </h4>
          </div>
        ...
        <div className="content--block">
          ...
          <div className="content--main">
            ...
            <p className="fade-in">
              ...
              decisions and that usability research confirmed the analysis that.
              I found that three main user insights will drive my design
              decisions and that usability research confirmed the analysis that.
            </p>
            <div className="fade-in content--point-section">
              <img className="content--point-icon" src="svg1.svg"></img>
              <div className="content--point">
                <h3 className="content--point-title">Point One</h3>
                <p>
                  Description of the point.As college students, myself and many
                  of my peers are managing our finances for the very first time
                  which… comes with a learning curve.
                </p>
              </div>
            </div>
            <div className="fade-in content--point-section">
              <img className="content--point-icon" src="svg2.svg"></img>
              <div className="content--point">
                <h3 className="content--point-title">Point One</h3>
                <p>
                  Description of the point.As college students, myself and many
            ...
            <div className="fade-in content--point-section">
              <img className="content--point-icon" src="svg3.svg"></img>
              <div className="content--point">
                <h3 className="content--point-title">Point One</h3>
                <p>
                  Description of the point.As college students, myself and many
            ...
            <div className="content--point-section">
              <div className="content--section-60">
                <p>
                  ...
                  students, myself and many of my peers are managing our
                  finances for the very first time which… comes with a learning
                  curve.
                </p>
              </div>
      ...
      <div id="grey">
        <div className="content--block">
          <div className="fade-in content--main">
            <h2>
              Thank you for reading about my project! This information is
              available as a <u>slide-deck here.</u>
            </h2>
            <h3 id="nextProject">
